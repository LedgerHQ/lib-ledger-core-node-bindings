...
NAN_METHOD(NJSAccount::asTezosLikeAccount) {

    //Check if method called with right number of arguments
    if(info.Length() != 0)
    {
        return Nan::ThrowError("NJSAccount::asTezosLikeAccount needs 0 arguments");
    }
    ...
    if(!cpp_impl)
    {
        return Nan::ThrowError("NJSAccount::asTezosLikeAccount : implementation of Account is not valid");
    }

    auto result = cpp_impl->asTezosLikeAccount();

    //Wrap result in node object
    auto arg_0 = NJSTezosLikeAccount::wrap(result);


    //Return result
    info.GetReturnValue().Set(arg_0);
}
NAN_METHOD(NJSAccount::asAlgorandAccount) {

    //Check if method called with right number of arguments
    if(info.Length() != 0)
    {
        return Nan::ThrowError("NJSAccount::asAlgorandAccount needs 0 arguments");
    }
    ...
    if(!cpp_impl)
    {
        return Nan::ThrowError("NJSAccount::asAlgorandAccount : implementation of Account is not valid");
    }

    auto result = cpp_impl->asAlgorandAccount();

    //Wrap result in node object
    auto arg_0 = NJSAlgorandAccount::wrap(result);


    //Return result
    info.GetReturnValue().Set(arg_0);
}
NAN_METHOD(NJSAccount::asStellarLikeAccount) {

    //Check if method called with right number of arguments
    if(info.Length() != 0)
    {
        return Nan::ThrowError("NJSAccount::asStellarLikeAccount needs 0 arguments");
    }
    ...
    if(!cpp_impl)
    {
        return Nan::ThrowError("NJSAccount::asStellarLikeAccount : implementation of Account is not valid");
    }

    auto result = cpp_impl->asStellarLikeAccount();

    //Wrap result in node object
    auto arg_0 = NJSStellarLikeAccount::wrap(result);
...
NAN_METHOD(NJSAccount::isInstanceOfStellarLikeAccount) {

    //Check if method called with right number of arguments
    if(info.Length() != 0)
    {
        return Nan::ThrowError("NJSAccount::isInstanceOfStellarLikeAccount needs 0 arguments");
    }
    ...
    if(!cpp_impl)
    {
        return Nan::ThrowError("NJSAccount::isInstanceOfStellarLikeAccount : implementation of Account is not valid");
    }

    auto result = cpp_impl->isInstanceOfStellarLikeAccount();
...
NAN_METHOD(NJSAccount::getAccountKeychain) {

    //Check if method called with right number of arguments
    if(info.Length() != 0)
    {
        return Nan::ThrowError("NJSAccount::getAccountKeychain needs 0 arguments");
    }
    ...
    if(!cpp_impl)
    {
        return Nan::ThrowError("NJSAccount::getAccountKeychain : implementation of Account is not valid");
    }

    auto result = cpp_impl->getAccountKeychain();

    //Wrap result in node object
    auto arg_0 = NJSKeychain::wrap(result);
...
void NJSAccount::Initialize(Local<Object> target) {
    ...
    Nan::SetPrototypeMethod(func_template,"asAlgorandAccount", asAlgorandAccount);
    Nan::SetPrototypeMethod(func_template,"asStellarLikeAccount", asStellarLikeAccount);
    ...
    Nan::SetPrototypeMethod(func_template,"isInstanceOfStellarLikeAccount", isInstanceOfStellarLikeAccount);
    ...
    Nan::SetPrototypeMethod(func_template,"getAccountKeychain", getAccountKeychain);
    Nan::SetPrototypeMethod(func_template,"isNull", isNull);
    //Set object prototype
    Account_prototype.Reset(objectTemplate);

    //Add template to target
    Nan::Set(target, Nan::New<String>("NJSAccount").ToLocalChecked(), Nan::GetFunction(func_template).ToLocalChecked());
}
