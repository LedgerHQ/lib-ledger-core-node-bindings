...
class NJSEthereumLikeExtendedPublicKey final {
public:

    static void Initialize(Local<Object> target);
    NJSEthereumLikeExtendedPublicKey() = delete;

    static Local<Object> wrap(const std::shared_ptr<ledger::core::api::EthereumLikeExtendedPublicKey> &object);
