...
void NJSBitcoinLikeTransactionCallback::onCallback(const std::shared_ptr<::ledger::core::api::BitcoinLikeTransaction> & result, const std::experimental::optional<::ledger::core::api::Error> & error)
{
