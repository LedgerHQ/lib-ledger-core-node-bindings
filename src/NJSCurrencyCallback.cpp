...
void NJSCurrencyCallback::onCallback(const std::experimental::optional<::ledger::core::api::Currency> & result, const std::experimental::optional<::ledger::core::api::Error> & error)
{
    ...
    if(result)
    {
        ...
        if(arg_0_optional.cosmosLikeNetworkParameters)
        {
            ...
            auto arg_0_tmp_7_tmp_5 = Nan::New<String>("0x" + djinni::js::hex::toString(arg_0_tmp_7_optional.AddressPrefix)).ToLocalChecked();

            Nan::DefineOwnProperty(arg_0_tmp_7_tmp, Nan::New<String>("AddressPrefix").ToLocalChecked(), arg_0_tmp_7_tmp_5);
            auto arg_0_tmp_7_tmp_6 = Nan::New<String>(arg_0_tmp_7_optional.ChainId).ToLocalChecked();
            Nan::DefineOwnProperty(arg_0_tmp_7_tmp, Nan::New<String>("ChainId").ToLocalChecked(), arg_0_tmp_7_tmp_6);
            Local<Array> arg_0_tmp_7_tmp_7 = Nan::New<Array>();
            for(size_t arg_0_tmp_7_tmp_7_id = 0; arg_0_tmp_7_tmp_7_id < arg_0_tmp_7_optional.AdditionalCIPs.size(); arg_0_tmp_7_tmp_7_id++)
            {
                auto arg_0_tmp_7_tmp_7_elem = Nan::New<String>(arg_0_tmp_7_optional.AdditionalCIPs[arg_0_tmp_7_tmp_7_id]).ToLocalChecked();
                Nan::Set(arg_0_tmp_7_tmp_7, (int)arg_0_tmp_7_tmp_7_id,arg_0_tmp_7_tmp_7_elem);
            }

            Nan::DefineOwnProperty(arg_0_tmp_7_tmp, Nan::New<String>("AdditionalCIPs").ToLocalChecked(), arg_0_tmp_7_tmp_7);
