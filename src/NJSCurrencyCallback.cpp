...
void NJSCurrencyCallback::onCallback(const std::experimental::optional<::ledger::core::api::Currency> & result, const std::experimental::optional<::ledger::core::api::Error> & error)
{
    ...
    if(result)
    {
        ...
        if(arg_0_optional.stellarLikeNetworkParameters)
        {
            ...
            Local<Array> arg_0_tmp_10_tmp_2 = Nan::New<Array>();
            for(size_t arg_0_tmp_10_tmp_2_id = 0; arg_0_tmp_10_tmp_2_id < arg_0_tmp_10_optional.Version.size(); arg_0_tmp_10_tmp_2_id++)
            {
                auto arg_0_tmp_10_tmp_2_elem = Nan::New<Uint32>(arg_0_tmp_10_optional.Version[arg_0_tmp_10_tmp_2_id]);
                arg_0_tmp_10_tmp_2->Set((int)arg_0_tmp_10_tmp_2_id,arg_0_tmp_10_tmp_2_elem);
            }
            ...
            for(size_t arg_0_tmp_10_tmp_5_id = 0; arg_0_tmp_10_tmp_5_id < arg_0_tmp_10_optional.AdditionalSEPs.size(); arg_0_tmp_10_tmp_5_id++)
            {
                ...
                arg_0_tmp_10_tmp_5->Set((int)arg_0_tmp_10_tmp_5_id,arg_0_tmp_10_tmp_5_elem);
            }
