...
public:
     ...
     */
    void onCallback(const std::experimental::optional<::ledger::core::api::ExtendedKeyAccountCreationInfo> & result, const std::experimental::optional<::ledger::core::api::Error> & error);
