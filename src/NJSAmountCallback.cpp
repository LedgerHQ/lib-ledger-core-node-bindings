...
void NJSAmountCallback::onCallback(const std::shared_ptr<::ledger::core::api::Amount> & result, const std::experimental::optional<::ledger::core::api::Error> & error)
{
...
void NJSAmountCallback::Initialize(Local<Object> target) {
    ...
    Nan::Set(target, Nan::New<String>("NJSAmountCallback").ToLocalChecked(), Nan::GetFunction(func_template).ToLocalChecked());
}
