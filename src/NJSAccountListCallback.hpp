...
public:
    ...
    static Local<Object> wrap(const std::shared_ptr<ledger::core::api::AccountListCallback> &object);
    static Nan::Persistent<ObjectTemplate> AccountListCallback_prototype;
     ...
     */
    void onCallback(const std::experimental::optional<std::vector<std::shared_ptr<::ledger::core::api::Account>>> & result, const std::experimental::optional<::ledger::core::api::Error> & error);
