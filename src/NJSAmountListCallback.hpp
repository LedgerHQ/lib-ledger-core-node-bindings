...
public:
     ...
     */
    void onCallback(const std::experimental::optional<std::vector<std::shared_ptr<::ledger::core::api::Amount>>> & result, const std::experimental::optional<::ledger::core::api::Error> & error);
