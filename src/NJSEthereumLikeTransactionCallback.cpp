...
void NJSEthereumLikeTransactionCallback::onCallback(const std::shared_ptr<::ledger::core::api::EthereumLikeTransaction> & result, const std::experimental::optional<::ledger::core::api::Error> & error)
{
...
NAN_METHOD(NJSEthereumLikeTransactionCallback::New) {
    ...
    auto node_instance = std::make_shared<NJSEthereumLikeTransactionCallback>(resolver);
    djinni::js::ObjectWrapper<NJSEthereumLikeTransactionCallback>::Wrap(node_instance, info.This());
...
void NJSEthereumLikeTransactionCallback::Initialize(Local<Object> target) {
    ...
    target->Set(Nan::New<String>("NJSEthereumLikeTransactionCallback").ToLocalChecked(), func_template->GetFunction(Nan::GetCurrentContext()).ToLocalChecked());
}
