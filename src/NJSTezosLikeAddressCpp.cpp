...
NAN_METHOD(NJSTezosLikeAddress::getVersion) {

    //Check if method called with right number of arguments
    if(info.Length() != 0)
    {
        return Nan::ThrowError("NJSTezosLikeAddress::getVersion needs 0 arguments");
    }

    //Check if parameters have correct types

    //Unwrap current object and retrieve its Cpp Implementation
    auto cpp_impl = djinni::js::ObjectWrapper<ledger::core::api::TezosLikeAddress>::Unwrap(info.This());
    if(!cpp_impl)
    {
        return Nan::ThrowError("NJSTezosLikeAddress::getVersion : implementation of TezosLikeAddress is not valid");
    }
...
NAN_METHOD(NJSTezosLikeAddress::getHash160) {

    //Check if method called with right number of arguments
    if(info.Length() != 0)
    {
        return Nan::ThrowError("NJSTezosLikeAddress::getHash160 needs 0 arguments");
    }
    ...
    if(!cpp_impl)
    {
        return Nan::ThrowError("NJSTezosLikeAddress::getHash160 : implementation of TezosLikeAddress is not valid");
    }
...
NAN_METHOD(NJSTezosLikeAddress::getNetworkParameters) {

    //Check if method called with right number of arguments
    if(info.Length() != 0)
    {
        return Nan::ThrowError("NJSTezosLikeAddress::getNetworkParameters needs 0 arguments");
    }
    ...
    if(!cpp_impl)
    {
        return Nan::ThrowError("NJSTezosLikeAddress::getNetworkParameters : implementation of TezosLikeAddress is not valid");
    }
...
NAN_METHOD(NJSTezosLikeAddress::toBase58) {

    //Check if method called with right number of arguments
    if(info.Length() != 0)
    {
        return Nan::ThrowError("NJSTezosLikeAddress::toBase58 needs 0 arguments");
    }
    ...
    if(!cpp_impl)
    {
        return Nan::ThrowError("NJSTezosLikeAddress::toBase58 : implementation of TezosLikeAddress is not valid");
    }
...
NAN_METHOD(NJSTezosLikeAddress::New) {
    //Only new allowed
    if(!info.IsConstructCall())
    {
        return Nan::ThrowError("NJSTezosLikeAddress function can only be called as constructor (use New)");
    }
    info.GetReturnValue().Set(info.This());
}


Nan::Persistent<ObjectTemplate> NJSTezosLikeAddress::TezosLikeAddress_prototype;

Local<Object> NJSTezosLikeAddress::wrap(const std::shared_ptr<ledger::core::api::TezosLikeAddress> &object) {
    Nan::EscapableHandleScope scope;
    Local<ObjectTemplate> local_prototype = Nan::New(TezosLikeAddress_prototype);
    ...
    {
        Nan::ThrowError("NJSTezosLikeAddress::wrap: object template not valid");
    }
    return scope.Escape(obj);
}

NAN_METHOD(NJSTezosLikeAddress::isNull) {
    auto cpp_implementation = djinni::js::ObjectWrapper<ledger::core::api::TezosLikeAddress>::Unwrap(info.This());
    auto isNull = !cpp_implementation ? true : false;
    return info.GetReturnValue().Set(Nan::New<Boolean>(isNull));
}

void NJSTezosLikeAddress::Initialize(Local<Object> target) {
    Nan::HandleScope scope;

    Local<FunctionTemplate> func_template = Nan::New<FunctionTemplate>(NJSTezosLikeAddress::New);
    Local<ObjectTemplate> objectTemplate = func_template->InstanceTemplate();
    objectTemplate->SetInternalFieldCount(1);

    func_template->SetClassName(Nan::New<String>("NJSTezosLikeAddress").ToLocalChecked());
